...
RUN git clone --depth 1 -b maint-23 https://github.com/diodechain/otp.git
...
RUN ./otp_build configure --xcomp-conf=xcomp/erl-xcomp-arm-android.conf --without-odbc --without-wx --without-debugger --without-observer --without-cdv --without-et
